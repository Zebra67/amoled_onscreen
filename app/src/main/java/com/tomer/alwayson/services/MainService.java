...
public class MainService extends Service implements SensorEventListener, ContextConstatns {
    ...
    public void onCreate() {
        ...
        frameLayout = new FrameLayout(this) {
            ...
            public boolean dispatchKeyEvent(KeyEvent event) {
                if ((event.getKeyCode() == KeyEvent.KEYCODE_VOLUME_UP || event.getKeyCode() == KeyEvent.KEYCODE_VOLUME_DOWN))
                    return !((gestureAction(prefs.volumeButtonsAction) || musicPlayer.isShown()) && !prefs.disableVolumeKeys);
        ...
        iv.setImageResource(R.drawable.ic_patreon);
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(
                RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.WRAP_CONTENT);
        lp.addRule(RelativeLayout.BELOW, R.id.memo_tv_2);
        lp.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);


        Glide.with(this)
                .load(Uri.parse("file:///android_asset/original.gif"))
                .apply(new RequestOptions().override(100, 100).placeholder(R.drawable.default_face).error(R.drawable.default_hour_hand))
                .into(iv);




        mainView.addView(iv, lp);
    ...
    private void setUpElements() {
        ...
        memoTV.setText("test d");
        TextView memoTV2 =  mainView.findViewById(R.id.memo_tv_2);
        memoTV2.setText("test d 2");
